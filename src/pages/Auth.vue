  ...
  <q-page padding class="bg-grey-3">
    ...
    >
      <q-card class="auth-tabs" v-if="auth.readLoggedIn">
        ...
        <q-card-actions>
          <q-space />
          <q-btn color="grey" rounded label="Estudo da Lei" to="/" />
        </q-card-actions>
        ...
        <q-card-actions>
          <q-space />
          <q-btn color="grey" rounded label="Jurisprudência" to="/todo" />
        </q-card-actions>
        <q-separator class="q-mb-md"></q-separator>
        <q-card-section>
          <div class="text-overline text-orange-9">link</div>
        ...
        <q-card-actions>
          <q-space />
          <q-btn color="grey" rounded label="Planejamento" to="/todo" />
        </q-card-actions>
      </q-card>
    </transition>
    <transition
